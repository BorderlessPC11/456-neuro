                  ...
                  <div className="modal-overlay">
                    <div className="modal-content">
                      ...
                      <form className="form-anamnese" onSubmit={handleAddNewAnamnese}>
                        {/* [todos os campos do form igual ao seu original, já postados acima] */}
                      ...
                      <form className="form-evolucao" onSubmit={handleAddNewEvolucao}>
                        ...
                        <div className="form-field">
                          ...
                          <div className="file-upload">
                            <input
                              type="file"
                              id="file-upload-evolucao"
                              onChange={handleNewEvolucaoFileChange}
                              accept="image/*,.pdf"
                            />
                            <label htmlFor="file-upload-evolucao" className="file-upload-label">
                              {newEvolucao.arquivo ? (
                                <>
                      ...
                      <form className="form-teste" onSubmit={handleAddNewTeste}>
                        ...
                        <div className="form-field">
                          ...
                          <div className="file-upload">
                            <input
                              type="file"
                              id="file-upload-teste"
                              onChange={handleNewTesteFileChange}
                              accept="image/*,.pdf"
                            />
                            <label htmlFor="file-upload-teste" className="file-upload-label">
                              {newTeste.arquivo ? (
                                <>
                        ...
                        <div className="form-field">
                          ...
                          <div className="file-upload">
                            <input
                              ...
                              required
                            />
                            <label htmlFor="file-upload-documento" className="file-upload-label">
